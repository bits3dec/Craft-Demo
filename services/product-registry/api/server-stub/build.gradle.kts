...
val serverPath = "$rootDir/services/product-registry/api/server-stub"
...
val generateServerStub by tasks.registering(GenerateTask::class) {
    ...
    apiPackage.set("demo.craft.product.registry.api")
    modelPackage.set("demo.craft.product.registry.model")
    configOptions.set(
        mapOf(
